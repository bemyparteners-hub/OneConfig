...
Ne pas ouvrir directement `index.html` en usage normal. Le mode fichier existe en secours, mais les exports DXF/fiche fonctionnent mieux via le serveur Python.
